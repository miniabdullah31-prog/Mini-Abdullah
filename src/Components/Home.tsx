  ...
  const cards = [
    {
      id: 1,
      title: "Duas",
      subtitle: "Daily duas for every moment",
    ...
    },
    {
      id: 2,
      title: "Quran",
      subtitle: "Learn & understand the Quran",
    ...
    },
    {
      ...
      image: require("../homeAssets/bookread.png"),
      bg: require("../homeAssets/yellowCard.jpg"),
    },
    {
      id: 4,
      title: "Islamic Learning",
      subtitle: "Learn Islam in a fun way",
    ...
    },
    {
      id: 6,
      title: "99 Names",
      subtitle: "Learn beautiful names of Allah",
      image: require("../homeAssets/tasbeeh2.png"),
      bg: require("../homeAssets/cyanCard.jpg"),
    },
    {
      id: 7,
      title: "Activities",
      subtitle: "Fun Islamic crafts & games",
    ...
    },
    {
      id: 9,
      title: "Good Deeds",
      subtitle: "Earn stars with good deeds",
        ...
        >
          ...
          >
            ...
            <View style={styles.quoteTop}>
              ...
              <Image
                source={require("../homeAssets/moon.png")}
                style={styles.smallIcon}
              />

              <Text style={styles.quoteBadge}>
                ✨ Daily Islamic Quote ✨
              </Text>
